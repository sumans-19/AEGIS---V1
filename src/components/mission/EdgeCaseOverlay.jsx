    ...
    <>
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
           <div style={{ color: '#1a565e', fontFamily: 'Rajdhani', fontSize: '20px', fontWeight: 'bold' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '8px' }}>
           <div style={{ color: '#1F282B', fontFamily: 'var(--font-mono, JetBrains Mono)', fontSize: '14px', fontWeight: 'bold' }}>
              STEP {edgeCaseStep} / 7
           </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
           <button 
            ...
            <button 
               ...
               style={{ background: 'transparent', border: '1px solid rgba(121, 185, 193, 0.4)', color: '#1F282B', padding: '8px', borderRadius: '4px', cursor: 'pointer' }}
            >
               <RotateCcw size={16} />
            </button>
            ...
            <div style={{ color: '#1F282B', fontFamily: 'var(--font-mono, JetBrains Mono)', fontSize: '14px', width: '40px', fontWeight: 'bold' }}>
